...
if "*.koyeb.app" not in allowed_hosts_list:
    allowed_hosts_list.append("*.koyeb.app")

if "*.netlify.app" not in allowed_hosts_list:
    allowed_hosts_list.append("*.netlify.app")
...
# Adicionar origins explícitos + regex para aceitar deploys do frontend
allow_origins = cors_origins_list.copy()
allow_origins.append(r"https://.*\.vercel\.app")
allow_origins.append(r"https://.*\.netlify\.app")
