...
O problema era que o `authenticate_user` buscava apenas por `username`, mas o login estava sendo feito com `email`. Foi corrigido para aceitar tanto `username` quanto `email`.
