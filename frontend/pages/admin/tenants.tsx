  ...
  return (
    <div className="p-6">
      ...
      <form onSubmit={handleSubmit} className="mb-4">
        <input value={name} onChange={e => setName(e.target.value)} placeholder="Nome" className="border p-2 mr-2" />
        <input value={parentTenantId} onChange={e => setParentTenantId(e.target.value)} placeholder="Parent Tenant ID" className="border p-2 mr-2" />
