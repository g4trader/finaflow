...
class LancamentoPrevisto(Base):
    """
    Lançamento Previsto - Espelho da planilha "Lançamentos Previstos"
    Estrutura similar aos Lançamentos Diários
    """
    __tablename__ = "lancamentos_previstos"
...
class LancamentoPrevistoCreate(BaseModel):
    """Criação de lançamento previsto"""
    data_prevista: str  # ISO format
    valor: Decimal
...
class LancamentoPrevistoUpdate(BaseModel):
    """Atualização de lançamento previsto"""
...
class LancamentoPrevistoResponse(BaseModel):
    """Resposta de lançamento previsto"""
    id: str
    data_prevista: str
